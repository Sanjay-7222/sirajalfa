...
!(function (e, t, n) {
  ...
  function h(e, n, o, i) {
    ...
    if (parseInt(o, 10))
      for (; o--; )
        ((a = p("div")).id = i ? i[o] : f + (o + 1)), c.appendChild(a);
    return (
      ...
      (r = n(c, e)),
      m.fake
        ? (m.parentNode.removeChild(m), (d.style.overflow = l), d.offsetHeight)
  ...
  var y,
    w = (y = e.matchMedia || e.msMatchMedia)
      ? function (e) {
          var t = y(e);
  ...
  var T = function (t) {
    ...
    for (var r = 0; r < i; r++) {
      var l = a[r];
      if (l.toUpperCase() + "_" + o in s)
        return "@-" + l.toLowerCase() + "-" + t;
    }
    return !1;
  };
  s.atRule = T;
  ...
  var O = { style: E.elem.style };
  function A(t, o) {
    var i = t.length;
    if ("CSS" in e && "supports" in e.CSS) {
      for (; i--; ) if (e.CSS.supports(c(t[i]), o)) return !0;
      return !1;
    }
  ...
  function G(e, t, o, i) {
    ...
    for (
      var r, a, d, u, c, m = ["modernizr", "tspan", "samp"];
      !O.style && m.length;

    )
      (r = !0), (O.modElem = p(m.shift())), (O.style = O.modElem.style);
    function g() {
  ...
  var z = (s.prefixed = function (e, t, n) {
    return 0 === e.indexOf("@")
      ? T(e)
      : (-1 != e.indexOf("-") && (e = f(e)), t ? M(e, t, n) : M(e, "pfx"));
  });
  ...
  !*/
    r.addTest("objectfit", !!z("objectFit"), { aliases: ["object-fit"] }),
    (s.testAllProps = L),
    /*!
  {
    "name": "CSS Animations",
  ...
  !*/
    r.addTest("cssgridlegacy", L("grid-columns", "10px", !0)),
    r.addTest("cssgrid", L("grid-template-rows", "none", !0)),
    /*!
  {
    "name": "CSS Filters",
    "property": "cssfilters",
  ...
  !*/
    r.addTest("cssfilters", function () {
      ...
      var e = p("a");
      return (
        (e.style.cssText = a.join("filter:blur(2px); ")),
    ...
    (function () {
      ...
      for (var u in i)
        if (i.hasOwnProperty(u)) {
          ...
          for (
            s = l(t.fn, "function") ? t.fn() : t.fn, a = 0;
            a < e.length;
            a++
          )
            1 === (d = e[a].split(".")).length
              ? (r[d[0]] = s)
              : (!r[d[0]] ||
                  r[d[0]] instanceof Boolean ||
                  (r[d[0]] = new Boolean(r[d[0]])),
                (r[d[0]][d[1]] = s)),
              o.push((s ? "" : "no-") + d.join("-"));
        }
    })(),
...
(dtGlobals.isMobile =
  ...
  jQuery(document).ready(function (e) {
    var t = document.getElementsByTagName("html")[0],
      n = document.body;
    if (
      (dtGlobals.isiOS ? t.classList.add("is-iOS") : t.classList.add("not-iOS"),
      -1 != navigator.userAgent.indexOf("Safari") &&
        -1 == navigator.userAgent.indexOf("Chrome") &&
        n.classList.add("is-safari"),
      dtGlobals.isWindowsPhone &&
        (n.classList.add("ie-mobile"), n.classList.add("windows-phone")),
      dtGlobals.isMobile || n.classList.add("no-mobile"),
      dtGlobals.isiPhone && n.classList.add("is-iphone"),
      (dtGlobals.isPhone = !1),
      ...
      -1 != o.indexOf("phone")
        ? (dtGlobals.isPhone = !0)
        : -1 != o.indexOf("tablet") && (dtGlobals.isTablet = !0);
    } else dtGlobals.isDesktop = !0;
    e(window)
      .on("the7_widget_resize", function (t) {
        e(".mini-widgets, .mobile-mini-widgets")
          .find(" > *")
